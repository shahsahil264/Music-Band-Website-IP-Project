    ...
    <body>
            ...
            <div id="book">
                <div class="container-fluid text-center">
                    <h2 class="bookH text-justify-center" >Book Tickets </h2>
                    <h4 class="aboutHBlack">Each ticket you buy, some portion of it goes to a charity.</h4>
                </div>
                <div class="container-fluid sectionLg">
                    <div class="row">
                        <div  class="col-sm-7 col-md-7 col-lg-7">
                            <div class="form-wrapper">
                            <form id="book_form" class="form-horizontal" action="action.php" method="POST">
                                ...
                                <div class="form-group">        
                                  ...
                                  <div class="col-sm-10">
                                      <input type="number" class="form-control" name="age" id="age" placeholder="Enter your age (Minimum 21 y/o)" min="21" max="99" value="21" required>
                                      <p class="infoField">* Minimum age required is 21 years.</p>

                                  </div>
                                </div>
                                <div class="form-group">        
                                  <label class="control-label col-sm-2" for="proof">Aadhar Card</label>
                                  <div class="col-sm-10">
                                      <input oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                      type = "number" maxlength = "16" class="form-control" name="proof" id="proof"placeholder="You need to carry it with you for identification" required>
                                      <p class="infoField">* Aadhar Card should be brought along for security and verification.</p>
                                ...
                                <div class="form-group">        
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="tickets" id="tickets"  value="1" readonly required>
                                        <p class="infoField"> * Only one ticket can be booked at a time for security and authentication purposes.</p>
                                    </div>
                                  </div>
                                <div class="form-group">        
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <p class="infoField"> * For signing-up and to see booked tickets.</p>
                                    </div>
                                  </div>
                                <div class="form-group">        
                                    <label class="control-label col-sm-2" for="pwdConf">Confirm Password</label>
                                    <div class="col-sm-10">
                                        <input type="password" class="form-control" name="pwdConf" id="pwdConf"  required>
                                        <span class="infoField"id="error"> * Confirm Password.</span>
                                    </div>
                                </div>
                                  <div class="form-group">        
                                    <div class="col-sm-offset-2 col-sm-10 text-center">
                                      <button name="submit-button" id="submit-button" type="submit" class="bookBtn">Confirm</button>
                                    </div>
                                  </div>
                              </form>
                            </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4><span class="glyphicon "></span> Tickets</h4>
        </div>
        <div class="modal-body">
          <form role="form" action="" method="post">
            <div class="form-group">
            <label for="name"><span class="glyphicon glyphicon-user"></span>Enter Name</label>
            <input id="name"  class="form-control" name="username" placeholder="username" type="text">            </div>
            <div class="form-group" >
              <label for="password"><span class="glyphicon glyphicon-lock"></span>Password</label>
              <input id="password"  class="form-control" name="password" placeholder="**********" type="password"><br><br>
            </div>
              <button name="submit" type="submit"class="btn btn-block">Pay 
